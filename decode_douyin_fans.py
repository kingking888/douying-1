...
from interceptors.fans import FansInterceptor
from interceptors.constants import INTERCEPT_FANS_PATH
import mitmproxy
...
interceptors = [FansInterceptor()]



# def write2File(response):
...
#         if interceptor.intercepted(flow):
#             interceptor.handle(flow)
#             break
